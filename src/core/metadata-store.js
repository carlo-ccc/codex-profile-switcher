...
function normalizeProfile(input) {
  ...
  return {
    ...
    auth_synced_at: input.auth_synced_at || null,
    auth_refreshed_at: input.auth_refreshed_at || null,
    auth_expires_at: input.auth_expires_at || null,
    auth_health: input.auth_health || "unknown",
